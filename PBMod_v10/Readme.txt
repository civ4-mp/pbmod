...
New in version 3 (PB Mod_v3): 
  ...
  • Webinterface: Add option to change the player colorset on running PB session.
    This is useful if two neighbours has the same culture border color.
...
New in version 6 (PB Mod_v6):
  • Allow start counter espionage mission at the last round of already running mission.
    This removes the 'one round hole' for the second player in an espionage war.
...
New in version 7 (PB Mod_v7):
  • Add gc.sendTurnCompletePB(iPlayer) function.
